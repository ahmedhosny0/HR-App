...
//                _repo.GetCurrentEmployee(userId);

//            ViewBag.Employees =
//                _repo.GetEmployees(userId, role);

//            ViewBag.RequestTypes =
//                _repo.GetRequestTypes();
...
//        }
//        [HttpPost]
//        public async  Task<IActionResult> CreateRequest(LeaveRequestVM model)
//        {
...
//                        var datescheck = _repo.GetEmployeeDates(model.EmployeeId);
...
//                        int usedDays = _repo.GetUsedLeaveDays(model.EmployeeId);
...
//                        {
//                            var balanceCheck = _repo.CheckLeaveBalance(
//                                model.EmployeeId,
//                                model.RequestTypeId,
//                                requestedDays
//                            );
